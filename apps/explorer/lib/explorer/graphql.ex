defmodule Explorer.GraphQL do
  ...
  def address_to_transactions_query(address_hash) do
    ...
    #    Note: this is ugly because it depends on internal absinthe logic in two ways:
    #     1) We assume they won't change the internal prefix they use for offsets
    #     2) We adds the prefix as the first first as their parsing method stops parsing on a non-digit character instead of erroring
